...
package com.example.myapplicatio.time_picker.widget;
...
import com.example.myapplicatio.time_picker.util.StateSet;
import com.example.myapplicatio.time_picker.util.Utils;
...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDER_HEIGHT = 6;
//    2
     ...
     */
    private static final int SIZE_UNSPECIFIED = 5;
//    -1
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        attrHandler(context, attrs, defStyleAttr, Utils.isLightTheme(context) ? R.style.DialogFullScreen: R.style.DialogStyle);
    }
