...
import com.example.myapplicatio.time_picker.util.DateFormatFix;
...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs,
        ...
        if (ViewCompat.getImportantForAccessibility(mDelegator) == IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
            ViewCompat.setImportantForAccessibility(mDelegator, IMPORTANT_FOR_ACCESSIBILITY_YES);
        }
    ...
    private void setContentDescriptions() {
        ...
        if (mAmPmSpinner != null) {
            trySetContentDescription(mAmPmSpinner, R.id.increment,
                    R.string.task_error_incorrect_start_date);
