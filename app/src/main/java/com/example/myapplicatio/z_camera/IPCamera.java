...
public class IPCamera extends Activity {
    ...
    private BroadCastRecieve receiver;

	public void broadcastIntent()
	{
		Intent intent = new Intent();
		intent.setAction(" com.example.myapplicatio.z_camera.BroadCastRecieve");
		intent.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
		sendBroadcast(intent);
	}
	private void configureReceiver() {
		IntentFilter filter = new IntentFilter();
		filter.addAction("com.example.myapplicatio.z_camera.BroadCastRecieve");
		receiver = new BroadCastRecieve();
	...
	private void reset() {
		mButton.setText(R.string.intro_start);
        mIsOn = true;
	}
